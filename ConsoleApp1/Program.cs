...
{
    Console.Clear();
    ExibirTitutloDaOpcao("Registro das bandas");
...
{
    Console.Clear();
    ExibirTitutloDaOpcao("Exibindo todas as bandas registradas");
...
void ExibirTitutloDaOpcao(string titulo)
{
...
void AvaliarUmaBanda()
{
    ...
    Console.Clear();
    ExibirTitutloDaOpcao("Avaliar banda");
...
{
    Console.Clear();
    ExibirTitutloDaOpcao("Média da banda");
    Console.Write("Digite a banda que você deseja exibir a média de avaliações: ");
    string nomeDaBanda = Console.ReadLine()!;
    //double media;
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
